...
class SmokeDelegate : public views::WidgetDelegate {
 public:
  views::View* GetContentsView() override { return &label_; }
  std::u16string GetWindowTitle() const override { return u"views-standalone smoke"; }
  bool CanResize() const override { return true; }
 private:
  views::Label label_{u"views-standalone smoke OK"};
};
}  // namespace
...
int main(int argc, char** argv) {
  ...
  base::FeatureList::InitInstance(cmd->GetSwitchValueASCII("enable-features"), cmd->GetSwitchValueASCII("disable-features"));
#endif
  ...
  auto* w = views::Widget::CreateWindowWithContext(
      new SmokeDelegate(), nullptr, gfx::Rect(50, 50, 480, 300));
  w->Show();
