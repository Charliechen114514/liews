...
LIBC_INLINE DFloat128 exp10_poly_approx_f128(const DFloat128 &dx) {
...
// step.
LIBC_INLINE DFloat128 exp10_f128(double x, double kd, int idx1, int idx2) {
  ...
  DFloat128 p = exp10_poly_approx_f128(dx);
