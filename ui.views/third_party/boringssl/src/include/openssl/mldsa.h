...
// `MLDSA65_prehash_update` and `MLDSA65_prehash_finalize` using `public_key`
...
// `MLDSA87_prehash_update` and `MLDSA87_prehash_finalize` using `public_key`
// and the same context as when the signature was generated. Returns 1 on
// success or 0 on error.
...
// `MLDSA44_prehash_update` and `MLDSA44_prehash_finalize` using `public_key`
// and the same context as when the signature was generated. Returns 1 on
// success or 0 on error.
