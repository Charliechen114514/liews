...
#ifndef COMPILER_TRANSLATOR_TREEOPS_HLSL_WRAPSWITCHSTATEMENTSINBLOCKS_H_
#define COMPILER_TRANSLATOR_TREEOPS_HLSL_WRAPSWITCHSTATEMENTSINBLOCKS_H_
...
#endif  // COMPILER_TRANSLATOR_TREEOPS_HLSL_WRAPSWITCHSTATEMENTSINBLOCKS_H_
