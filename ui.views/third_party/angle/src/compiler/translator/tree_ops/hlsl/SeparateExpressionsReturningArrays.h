...
#ifndef COMPILER_TRANSLATOR_TREEOPS_HLSL_SEPARATEEXPRESSIONSRETURNINGARRAYS_H_
#define COMPILER_TRANSLATOR_TREEOPS_HLSL_SEPARATEEXPRESSIONSRETURNINGARRAYS_H_
...
#endif  // COMPILER_TRANSLATOR_TREEOPS_HLSL_SEPARATEEXPRESSIONSRETURNINGARRAYS_H_
