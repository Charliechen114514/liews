...
#ifndef COMPILER_TRANSLATOR_TREEOPS_HLSL_SEPARATEARRAYCONSTRUCTORSTATEMENTS_H_
#define COMPILER_TRANSLATOR_TREEOPS_HLSL_SEPARATEARRAYCONSTRUCTORSTATEMENTS_H_
...
#endif  // COMPILER_TRANSLATOR_TREEOPS_HLSL_SEPARATEARRAYCONSTRUCTORSTATEMENTS_H_
