...
#ifndef COMPILER_TRANSLATOR_TREEOPS_HLSL_REWRITEUNARYMINUSOPERATORINT_H_
#define COMPILER_TRANSLATOR_TREEOPS_HLSL_REWRITEUNARYMINUSOPERATORINT_H_
...
#endif  // COMPILER_TRANSLATOR_TREEOPS_HLSL_REWRITEUNARYMINUSOPERATORINT_H_
