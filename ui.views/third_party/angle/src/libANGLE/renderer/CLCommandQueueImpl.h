...
class CLCommandQueueImpl : angle::NonCopyable
{
  public:
    ...
    virtual angle::Result enqueueMarker(cl::EventPtr &event) = 0;
    ...
    virtual angle::Result enqueueAcquireExternalMemObjectsKHR(const cl::MemoryPtrs &memObjects,
                                                              const cl::EventPtrs &waitEvents,
                                                              cl::EventPtr &event) = 0;

    virtual angle::Result enqueueReleaseExternalMemObjectsKHR(const cl::MemoryPtrs &memObjects,
                                                              const cl::EventPtrs &waitEvents,
                                                              cl::EventPtr &event) = 0;
