...
#ifndef VIDEO_TIMING_INTER_FRAME_DELAY_VARIATION_CALCULATOR_H_
#define VIDEO_TIMING_INTER_FRAME_DELAY_VARIATION_CALCULATOR_H_
...
#endif  // VIDEO_TIMING_INTER_FRAME_DELAY_VARIATION_CALCULATOR_H_
