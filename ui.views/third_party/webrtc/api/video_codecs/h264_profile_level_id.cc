...
constexpr ProfilePattern kProfilePatterns[] = {
    {.profile_idc = 0x42,
     ...
     .profile = H264Profile::kProfileConstrainedBaseline},
    {.profile_idc = 0x4D,
    ...
    {.profile_idc = 0x42,
     ...
     .profile = H264Profile::kProfileBaseline},
    {.profile_idc = 0x58,
     .profile_iop = BitPattern("10xx0000"),
     .profile = H264Profile::kProfileBaseline},
    {.profile_idc = 0x4D,
     .profile_iop = BitPattern("0x0x0000"),
     .profile = H264Profile::kProfileMain},
    {.profile_idc = 0x64,
     .profile_iop = BitPattern("00000000"),
     .profile = H264Profile::kProfileHigh},
    {.profile_idc = 0x64,
     .profile_iop = BitPattern("00001100"),
     .profile = H264Profile::kProfileConstrainedHigh},
    {.profile_idc = 0xF4,
     .profile_iop = BitPattern("00000000"),
     .profile = H264Profile::kProfilePredictiveHigh444}};
