...
// If enabled, it turns into RTC_CHECK.
// If disabled, it turns into RTC_DCHECK.
// This resembles the behavior of ABSL_HARDENING_ASSERT,
// but is not affected by NDEBUG.
#ifdef RTC_HARDENING
