...
void ff_put_pixels8_x2_sse2(uint8_t *block, const uint8_t *pixels,
...
void ff_avg_pixels16_y2_sse2(uint8_t *block, const uint8_t *pixels,
                             ptrdiff_t line_size, int h);
void ff_put_no_rnd_pixels8_x2_approx_sse2(uint8_t *block, const uint8_t *pixels,
                                          ptrdiff_t line_size, int h);
void ff_put_no_rnd_pixels8_x2_sse2(uint8_t *block, const uint8_t *pixels,
                                   ptrdiff_t line_size, int h);
...
void ff_avg_no_rnd_pixels16_x2_sse2(uint8_t *block, const uint8_t *pixels,
                                    ptrdiff_t line_size, int h);
void ff_put_pixels8_y2_sse2(uint8_t *block, const uint8_t *pixels,
                            ptrdiff_t line_size, int h);
void ff_put_no_rnd_pixels8_y2_approx_sse2(uint8_t *block, const uint8_t *pixels,
                                          ptrdiff_t line_size, int h);
void ff_put_no_rnd_pixels8_y2_sse2(uint8_t *block, const uint8_t *pixels,
                                   ptrdiff_t line_size, int h);
...
void ff_avg_no_rnd_pixels16_xy2_sse2(uint8_t *block, const uint8_t *pixels,
                                     ptrdiff_t line_size, int h);
void ff_avg_pixels8_x2_sse2(uint8_t *block, const uint8_t *pixels,
                            ptrdiff_t line_size, int h);
void ff_avg_pixels8_y2_sse2(uint8_t *block, const uint8_t *pixels,
                            ptrdiff_t line_size, int h);
...
static void hpeldsp_init_sse2(HpelDSPContext *c, int flags)
{
    ...
    c->put_no_rnd_pixels_tab[1][1] = ff_put_no_rnd_pixels8_x2_sse2;
    c->put_no_rnd_pixels_tab[1][2] = ff_put_no_rnd_pixels8_y2_sse2;
    c->put_no_rnd_pixels_tab[1][0] =
    c->put_pixels_tab[1][0]        = ff_put_pixels8_sse2;
    c->put_pixels_tab[1][1]        = ff_put_pixels8_x2_sse2;
    c->put_pixels_tab[1][2]        = ff_put_pixels8_y2_sse2;
    ...
    c->avg_pixels_tab[1][1]        = ff_avg_pixels8_x2_sse2;
    c->avg_pixels_tab[1][2]        = ff_avg_pixels8_y2_sse2;
    ...
    if (!(flags & AV_CODEC_FLAG_BITEXACT)) {
        c->put_no_rnd_pixels_tab[1][1] = ff_put_no_rnd_pixels8_x2_approx_sse2;
        c->put_no_rnd_pixels_tab[1][2] = ff_put_no_rnd_pixels8_y2_approx_sse2;
    }
