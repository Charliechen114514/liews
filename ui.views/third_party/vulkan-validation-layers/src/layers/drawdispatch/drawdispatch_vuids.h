...
enum class ActionVUID {
    ...
    TENSOR_09900,
    TENSOR_09905,
    PER_TILE_DRAW_ENABLED_10677,
    TILE_SHADING_SHADER_STAGE_10678,
    PER_TILE_MODEL_FEEDBACK_LOOP_IMAGE_ACCESS_10679,

    IMAGE_SAMPLE_WEIGHTED_QCOM_06971,
    IMAGE_SAMPLE_WEIGHTED_QCOM_06972,
    IMAGE_BOX_FILTER_QCOM_06973,
    IMAGE_BLOCK_MATCH_SSD_QCOM_06974,
    IMAGE_PROCESSING_SAMPLE_QCOM_06977,
    IMAGE_PROCESSING_SAMPLE_QCOM_06978,
    IMAGE_BLOCK_MATCH_WINDOW_QCOM_09215,
    IMAGE_BLOCK_MATCH_WINDOW_QCOM_09216,
    IMAGE_BLOCK_MATCH_SAD_QCOM_12420,
    IMAGE_BLOCK_MATCH_WINDOW_QCOM_12421,
    IMAGE_BLOCK_MATCH_WINDOW_QCOM_12422,
    ...
    PER_TILE_DISPATCH_ENABLED_10674,
    ...
    XFB_QUERIES_07074,
    PG_QUERIES_07075,
    PIPELINE_STATISTICS_QUERIES_07076,
    ...
    // GPU-AV
    UNIFORM_ACCESS_OOB_06935,
    STORAGE_ACCESS_OOB_06936,
    UNIFORM_ACCESS_OOB_08612,
    STORAGE_ACCESS_OOB_08613,
    INVALID_DESCRIPTOR_08114,
    DESCRIPTOR_INDEX_OOB_10068,
    DESCRIPTOR_BUFFER_08116,
    DESCRIPTOR_HEAP_OOB_11309,
    DESCRIPTOR_HEAP_ALIGNMENT_11297,
    DESCRIPTOR_HEAP_ALIGNMENT_11298,
    DESCRIPTOR_HEAP_ALIGNMENT_11299,
    DESCRIPTOR_HEAP_INDIRECT_INDEX_PUSH_11300,
    DESCRIPTOR_HEAP_INDIRECT_ADDRESS_PUSH_11304,
    DESCRIPTOR_HEAP_ADDRESS_BUFFER_ALIGNMENT_11441,
    DESCRIPTOR_HEAP_ADDRESS_BUFFER_ALIGNMENT_11442,
    DESCRIPTOR_HEAP_INVALID_ADDRESS_11301,
    DESCRIPTOR_HEAP_INVALID_ADDRESS_11302,
    DESCRIPTOR_HEAP_INVALID_ADDRESS_11305,
    DESCRIPTOR_HEAP_INVALID_ADDRESS_11306,
    DESCRIPTOR_HEAP_HASHING_12472,
