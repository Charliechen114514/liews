...
''')
    ...
    def getManualParentVUID(self, memberName: str, structName: str, commandName: str):
        ...
        if structName == 'VkCopyDeviceMemoryImageInfoKHR' and memberName == 'image':
            return '"UNASSIGNED-VkCopyDeviceMemoryImageInfoKHR-image-parent"'
        if structName == 'VkGpaSessionCreateInfoAMD' and memberName == 'secondaryCopySource':
            return '"UNASSIGNED-VkGpaSessionCreateInfoAMD-secondaryCopySource-parent"'
    ...
    def validateObjects(self, members: list[Member], prefix: str, arrayIndex: int, parentName: str, topCommand: str, errorLoc: str) -> str:
        ...
        for member in members:
            ...
            if member.type in self.vk.handles:
                ...
                # dispactches the calls to vvl::BaseDevice. If invalid handle is used it will cause
