# Development Assistant - Meta Prompt for src/tint

This file contains Agentic RAG guidance for `src/tint`. Use it to find the most
...
This is a guide to fundamental architectural concepts in Tint. Use it to orient
