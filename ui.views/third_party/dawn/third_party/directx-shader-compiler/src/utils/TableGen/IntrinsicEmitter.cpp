...
static void EncodeFixedType(Record *R, std::vector<unsigned char> &ArgCodes,
  ...
  switch (VT) {
  default: break;
  case MVT::iPTRAny: ++Tmp; LLVM_FALLTHROUGH; // HLSL Change
  case MVT::vAny: ++Tmp; LLVM_FALLTHROUGH; // HLSL Change
  case MVT::fAny: ++Tmp; LLVM_FALLTHROUGH; // HLSL Change
  case MVT::iAny: ++Tmp; LLVM_FALLTHROUGH; // HLSL Change
  case MVT::Any: {
