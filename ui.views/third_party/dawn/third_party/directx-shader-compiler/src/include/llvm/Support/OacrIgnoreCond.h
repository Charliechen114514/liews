...
#pragma prefast(                                                               \
    disable                                                                    \
    : __WARNING_NONZEROLOGICALOR,                                              \
      "external project has dead branches for unsupported configuration combinations, by design")
// OACR error 6236
#pragma prefast(                                                               \
    disable                                                                    \
    : __WARNING_LOGICALORNONZERO,                                              \
      "external project has dead branches for unsupported configuration combinations, by design")
// OACR error 6236
#pragma prefast(                                                               \
    disable                                                                    \
    : __WARNING_ZEROLOGICALANDLOSINGSIDEEFFECTS,                               \
      "external project has dead branches for unsupported configuration combinations, by design")
// OACR error 6285
#pragma prefast(                                                               \
    disable                                                                    \
    : __WARNING_LOGICALOROFCONSTANTS,                                          \
      "external project has dead branches for unsupported configuration combinations, by design")
// OACR error 6286
#pragma prefast(                                                               \
    disable                                                                    \
...
#pragma prefast(                                                               \
    disable                                                                    \
    : __WARNING_REDUNDANTTEST,                                                 \
      "external project has dead branches for unsupported configuration combinations, by design")

// local variable is initialized but not referenced - every LangOpts use on
// stack triggers this
