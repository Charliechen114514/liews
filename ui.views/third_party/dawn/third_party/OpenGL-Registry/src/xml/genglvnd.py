...
# These are extensions to be included in the libglvnd GL/gl.h header.
glVndList = [
    'GL_ARB_imaging',
    'GL_ARB_multitexture'
]
...
# conventions
glPlatformStrings    = [ '#include <GL/glplatform.h>', '' ]
...
buildList = [
    ...
    CGeneratorOptions(
        ...
        apientry          = 'APIENTRY ',
        apientryp         = 'APIENTRYP '),
    # GL compatibility profile through GL 1.3 (for libglvnd) - GL/gl.h
    CGeneratorOptions(
        filename          = 'drafts/GL/gl.h',
        apiname           = 'gl',
        profile           = 'compatibility',
        versions          = allVersions,
        emitversions      = gl13Pat,
        defaultExtensions = None,                   # No extensions for gl.h
        addExtensions     = glVndPat,
        removeExtensions  = None,
        prefixText        = prefixStrings + glPlatformStrings,
        genFuncPointers   = True,
        protectFile       = protectFile,
        protectFeature    = protectFeature,
        protectProto      = False,                  # gl.h always includes prototypes
        protectProtoStr   = 'GL_GLEXT_PROTOTYPES',
        apicall           = 'GLAPI ',
        apientry          = 'APIENTRY ',
        apientryp         = 'APIENTRYP '),
    ...
    CGeneratorOptions(
        filename          = 'drafts/GL/glcorearb.h',
        apiname           = 'gl',
        profile           = 'core',
        versions          = allVersions,
