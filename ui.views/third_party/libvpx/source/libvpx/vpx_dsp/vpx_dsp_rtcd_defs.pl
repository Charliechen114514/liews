...
$avx2_asm = $sse2_asm = $ssse3_asm = $sse2_x86_64_asm = $ssse3_x86_64_asm = '';
if (vpx_config("HAVE_X86_ASM") eq "yes") {
  $avx2_asm = 'avx2';
  $sse2_asm = 'sse2';
  $ssse3_asm = 'ssse3';
  if ($opts{arch} eq "x86_64") {
    $sse2_x86_64_asm = 'sse2';
    $ssse3_x86_64_asm = 'ssse3';
  }
}
...
specialize qw/vpx_d63_predictor_4x4 neon/, "$ssse3_asm";
...
specialize qw/vpx_h_predictor_4x4 neon dspr2 msa/, "$sse2_asm";
...
specialize qw/vpx_h_predictor_32x32 neon msa vsx/, "$sse2_asm";
...
specialize qw/vpx_dc_left_predictor_32x32 msa neon vsx/, "$sse2_asm";

add_proto qw/void vpx_dc_128_predictor_32x32/, "uint8_t *dst, ptrdiff_t stride, const uint8_t *above, const uint8_t *left";
specialize qw/vpx_dc_128_predictor_32x32 msa neon vsx/, "$sse2_asm";
...
if (vpx_config("CONFIG_VP9_HIGHBITDEPTH") eq "yes") {
  ...
  specialize qw/vpx_highbd_v_predictor_4x4 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_tm_predictor_4x4 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_dc_predictor_4x4 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_v_predictor_8x8 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_tm_predictor_8x8 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_dc_predictor_8x8 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_d207_predictor_16x16 neon ssse3 avx2/;
  ...
  specialize qw/vpx_highbd_d63_predictor_16x16 neon ssse3 avx2/;
  ...
  specialize qw/vpx_highbd_v_predictor_16x16 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_tm_predictor_16x16 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_d207_predictor_32x32 neon ssse3 avx2 avx512/;
  ...
  specialize qw/vpx_highbd_d63_predictor_32x32 neon ssse3 avx2 avx512/;
  ...
  specialize qw/vpx_highbd_v_predictor_32x32 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_tm_predictor_32x32 neon/, "$sse2_asm";
...
specialize qw/vpx_convolve_copy neon dspr2 msa vsx lsx/, "$sse2_asm";
...
specialize qw/vpx_convolve_avg neon dspr2 msa vsx mmi lsx/, "$sse2_asm";
...
specialize qw/vpx_convolve8 neon neon_dotprod neon_i8mm dspr2 msa vsx mmi lsx/, "$sse2_asm", "$ssse3_asm", "$avx2_asm";
...
specialize qw/vpx_convolve8_horiz neon neon_dotprod neon_i8mm dspr2 msa vsx mmi lsx/, "$sse2_asm", "$ssse3_asm", "$avx2_asm";
...
specialize qw/vpx_convolve8_vert neon neon_dotprod neon_i8mm dspr2 msa vsx mmi lsx/, "$sse2_asm", "$ssse3_asm", "$avx2_asm";
...
specialize qw/vpx_convolve8_avg neon neon_dotprod neon_i8mm dspr2 msa vsx mmi lsx/, "$sse2_asm", "$ssse3_asm", "$avx2_asm";
...
specialize qw/vpx_convolve8_avg_horiz neon neon_dotprod neon_i8mm dspr2 msa vsx mmi lsx/, "$sse2_asm", "$ssse3_asm", "$avx2_asm";
...
specialize qw/vpx_convolve8_avg_vert neon neon_dotprod neon_i8mm dspr2 msa vsx mmi lsx/, "$sse2_asm", "$ssse3_asm", "$avx2_asm";
...
specialize qw/vpx_scaled_2d neon msa/, "$ssse3_asm";
...
if (vpx_config("CONFIG_VP9_HIGHBITDEPTH") eq "yes") {
  ...
  specialize qw/vpx_highbd_convolve_copy avx2 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_convolve_avg avx2 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_convolve8 neon sve2/, "$sse2_x86_64_asm", "$avx2_asm";
  ...
  specialize qw/vpx_highbd_convolve8_horiz neon sve/, "$sse2_x86_64_asm", "$avx2_asm";
  ...
  specialize qw/vpx_highbd_convolve8_vert neon sve2/, "$sse2_x86_64_asm", "$avx2_asm";
  ...
  specialize qw/vpx_highbd_convolve8_avg neon sve2/, "$sse2_x86_64_asm", "$avx2_asm";
  ...
  specialize qw/vpx_highbd_convolve8_avg_horiz neon sve/, "$sse2_x86_64_asm", "$avx2_asm";
  ...
  specialize qw/vpx_highbd_convolve8_avg_vert neon sve2/, "$sse2_x86_64_asm", "$avx2_asm";
}  # CONFIG_VP9_HIGHBITDEPTH
...
if (vpx_config("CONFIG_EMULATE_HARDWARE") ne "yes") {
  ...
  specialize qw/vpx_iwht4x4_16_add vsx/, "$sse2_asm";
...
specialize qw/vpx_subtract_block neon msa mmi avx2 vsx lsx/, "$sse2_asm";
...
specialize qw/vpx_sad_skip_4x8 neon/, "$sse2_asm";
...
if (vpx_config("CONFIG_VP9_ENCODER") eq "yes") {
  ...
  if (vpx_config("CONFIG_VP9_HIGHBITDEPTH") eq "yes") {
    ...
    specialize qw/vpx_hadamard_8x8 sse2 neon vsx lsx/, "$ssse3_x86_64_asm";
...
specialize qw/vpx_sad64x64_avg neon neon_dotprod avx512 avx2 msa vsx mmi lsx/, "$sse2_asm";
...
specialize qw/vpx_sad64x32_avg neon neon_dotprod avx512 avx2 msa vsx mmi/, "$sse2_asm";
...
specialize qw/vpx_sad32x64_avg neon neon_dotprod avx2 msa vsx mmi/, "$sse2_asm";
...
specialize qw/vpx_sad32x32_avg neon neon_dotprod avx2 msa vsx mmi lsx/, "$sse2_asm";
...
specialize qw/vpx_sad32x16_avg neon neon_dotprod avx2 msa vsx mmi/, "$sse2_asm";
...
specialize qw/vpx_sad16x32_avg neon neon_dotprod msa vsx mmi/, "$sse2_asm";
...
specialize qw/vpx_sad16x16_avg neon neon_dotprod msa vsx mmi/, "$sse2_asm";
...
specialize qw/vpx_sad16x8_avg neon neon_dotprod msa vsx mmi/, "$sse2_asm";
...
specialize qw/vpx_sad8x16_avg neon msa mmi/, "$sse2_asm";
...
specialize qw/vpx_sad8x8_avg neon msa mmi/, "$sse2_asm";
...
specialize qw/vpx_sad8x4_avg neon msa mmi/, "$sse2_asm";
...
specialize qw/vpx_sad4x8_avg neon msa mmi/, "$sse2_asm";
...
specialize qw/vpx_sad4x4_avg neon msa mmi/, "$sse2_asm";
...
specialize qw/vpx_sad64x64x4d avx512 avx2 neon neon_dotprod msa vsx mmi lsx/, "$sse2_asm";
...
specialize qw/vpx_sad64x32x4d neon neon_dotprod msa vsx mmi lsx/, "$sse2_asm";
...
specialize qw/vpx_sad32x64x4d neon neon_dotprod msa vsx mmi lsx/, "$sse2_asm";
...
specialize qw/vpx_sad32x32x4d avx2 neon neon_dotprod msa vsx mmi lsx/, "$sse2_asm";
...
specialize qw/vpx_sad32x16x4d neon neon_dotprod msa vsx mmi/, "$sse2_asm";
...
specialize qw/vpx_sad16x32x4d neon neon_dotprod msa vsx mmi/, "$sse2_asm";
...
specialize qw/vpx_sad16x16x4d neon neon_dotprod msa vsx mmi lsx/, "$sse2_asm";
...
specialize qw/vpx_sad16x8x4d neon neon_dotprod msa vsx mmi/, "$sse2_asm";
...
specialize qw/vpx_sad8x16x4d neon msa mmi/, "$sse2_asm";
...
specialize qw/vpx_sad8x8x4d neon msa mmi lsx/, "$sse2_asm";
...
specialize qw/vpx_sad8x4x4d neon msa mmi/, "$sse2_asm";
...
specialize qw/vpx_sad4x8x4d neon msa mmi/, "$sse2_asm";
...
specialize qw/vpx_sad4x4x4d neon msa mmi/, "$sse2_asm";
...
specialize qw/vpx_sad_skip_64x64x4d neon neon_dotprod avx512 avx2/, "$sse2_asm";
...
specialize qw/vpx_sad_skip_64x32x4d neon neon_dotprod avx512 avx2/, "$sse2_asm";
...
specialize qw/vpx_sad_skip_32x64x4d neon neon_dotprod avx2/, "$sse2_asm";
...
specialize qw/vpx_sad_skip_32x32x4d neon neon_dotprod avx2/, "$sse2_asm";
...
specialize qw/vpx_sad_skip_32x16x4d neon neon_dotprod avx2/, "$sse2_asm";
...
specialize qw/vpx_sad_skip_16x32x4d neon neon_dotprod/, "$sse2_asm";
...
specialize qw/vpx_sad_skip_16x16x4d neon neon_dotprod/, "$sse2_asm";
...
specialize qw/vpx_sad_skip_16x8x4d neon neon_dotprod/, "$sse2_asm";
...
specialize qw/vpx_sad_skip_8x16x4d neon/, "$sse2_asm";
...
specialize qw/vpx_sad_skip_8x8x4d neon/, "$sse2_asm";
...
specialize qw/vpx_sad_skip_4x8x4d neon/, "$sse2_asm";
...
if (vpx_config("CONFIG_INTERNAL_STATS") eq "yes") {
    ...
    specialize qw/vpx_ssim_parms_8x8/, "$sse2_x86_64_asm";
}
...
if (vpx_config("CONFIG_VP9_HIGHBITDEPTH") eq "yes") {
  ...
  specialize qw/vpx_highbd_sad_skip_64x64 neon avx2/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_sad_skip_64x32 neon avx2/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_sad_skip_32x64 neon avx2/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_sad_skip_32x32 neon avx2/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_sad_skip_32x16 neon avx2/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_sad_skip_16x32 neon avx2/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_sad_skip_16x16 neon avx2/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_sad_skip_16x8 neon avx2/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_sad_skip_8x16 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_sad_skip_8x8 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_sad64x64_avg neon avx2/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_sad64x32_avg neon avx2/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_sad32x64_avg neon avx2/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_sad32x32_avg neon avx2/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_sad32x16_avg neon avx2/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_sad16x32_avg neon avx2/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_sad16x16_avg neon avx2/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_sad16x8_avg neon avx2/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_sad8x16_avg neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_sad8x8_avg neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_sad8x4_avg neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_sad64x64x4d neon avx2/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_sad64x32x4d neon avx2/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_sad32x64x4d neon avx2/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_sad32x32x4d neon avx2/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_sad32x16x4d neon avx2/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_sad16x32x4d neon avx2/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_sad16x16x4d neon avx2/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_sad16x8x4d neon avx2/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_sad8x16x4d neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_sad8x8x4d neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_sad8x4x4d neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_sad4x8x4d neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_sad4x4x4d neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_sad_skip_64x64x4d neon avx2/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_sad_skip_64x32x4d neon avx2/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_sad_skip_32x64x4d neon avx2/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_sad_skip_32x32x4d neon avx2/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_sad_skip_32x16x4d neon avx2/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_sad_skip_16x32x4d neon avx2/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_sad_skip_16x16x4d neon avx2/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_sad_skip_16x8x4d neon avx2/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_sad_skip_8x16x4d neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_sad_skip_8x8x4d neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_sad_skip_4x8x4d neon/, "$sse2_asm";
...
add_proto qw/uint32_t vpx_sub_pixel_avg_variance64x64/, "const uint8_t *src_ptr, int src_stride, int x_offset, int y_offset, const uint8_t *ref_ptr, int ref_stride, uint32_t *sse, const uint8_t *second_pred";
  specialize qw/vpx_sub_pixel_avg_variance64x64 neon avx2 msa mmi lsx/, "$sse2_asm", "$ssse3_asm";
...
add_proto qw/uint32_t vpx_sub_pixel_avg_variance64x32/, "const uint8_t *src_ptr, int src_stride, int x_offset, int y_offset, const uint8_t *ref_ptr, int ref_stride, uint32_t *sse, const uint8_t *second_pred";
  specialize qw/vpx_sub_pixel_avg_variance64x32 neon msa mmi/, "$sse2_asm", "$ssse3_asm";
...
add_proto qw/uint32_t vpx_sub_pixel_avg_variance32x64/, "const uint8_t *src_ptr, int src_stride, int x_offset, int y_offset, const uint8_t *ref_ptr, int ref_stride, uint32_t *sse, const uint8_t *second_pred";
  specialize qw/vpx_sub_pixel_avg_variance32x64 neon msa mmi/, "$sse2_asm", "$ssse3_asm";
...
add_proto qw/uint32_t vpx_sub_pixel_avg_variance32x32/, "const uint8_t *src_ptr, int src_stride, int x_offset, int y_offset, const uint8_t *ref_ptr, int ref_stride, uint32_t *sse, const uint8_t *second_pred";
  specialize qw/vpx_sub_pixel_avg_variance32x32 neon avx2 msa mmi/, "$sse2_asm", "$ssse3_asm";
...
add_proto qw/uint32_t vpx_sub_pixel_avg_variance32x16/, "const uint8_t *src_ptr, int src_stride, int x_offset, int y_offset, const uint8_t *ref_ptr, int ref_stride, uint32_t *sse, const uint8_t *second_pred";
  specialize qw/vpx_sub_pixel_avg_variance32x16 neon msa mmi/, "$sse2_asm", "$ssse3_asm";
...
add_proto qw/uint32_t vpx_sub_pixel_avg_variance16x32/, "const uint8_t *src_ptr, int src_stride, int x_offset, int y_offset, const uint8_t *ref_ptr, int ref_stride, uint32_t *sse, const uint8_t *second_pred";
  specialize qw/vpx_sub_pixel_avg_variance16x32 neon msa mmi/, "$sse2_asm", "$ssse3_asm";
...
add_proto qw/uint32_t vpx_sub_pixel_avg_variance16x16/, "const uint8_t *src_ptr, int src_stride, int x_offset, int y_offset, const uint8_t *ref_ptr, int ref_stride, uint32_t *sse, const uint8_t *second_pred";
  specialize qw/vpx_sub_pixel_avg_variance16x16 neon msa mmi/, "$sse2_asm", "$ssse3_asm";
...
add_proto qw/uint32_t vpx_sub_pixel_avg_variance16x8/, "const uint8_t *src_ptr, int src_stride, int x_offset, int y_offset, const uint8_t *ref_ptr, int ref_stride, uint32_t *sse, const uint8_t *second_pred";
  specialize qw/vpx_sub_pixel_avg_variance16x8 neon msa mmi/, "$sse2_asm", "$ssse3_asm";
...
add_proto qw/uint32_t vpx_sub_pixel_avg_variance8x16/, "const uint8_t *src_ptr, int src_stride, int x_offset, int y_offset, const uint8_t *ref_ptr, int ref_stride, uint32_t *sse, const uint8_t *second_pred";
  specialize qw/vpx_sub_pixel_avg_variance8x16 neon msa mmi/, "$sse2_asm", "$ssse3_asm";
...
add_proto qw/uint32_t vpx_sub_pixel_avg_variance8x8/, "const uint8_t *src_ptr, int src_stride, int x_offset, int y_offset, const uint8_t *ref_ptr, int ref_stride, uint32_t *sse, const uint8_t *second_pred";
  specialize qw/vpx_sub_pixel_avg_variance8x8 neon msa mmi/, "$sse2_asm", "$ssse3_asm";
...
add_proto qw/uint32_t vpx_sub_pixel_avg_variance8x4/, "const uint8_t *src_ptr, int src_stride, int x_offset, int y_offset, const uint8_t *ref_ptr, int ref_stride, uint32_t *sse, const uint8_t *second_pred";
  specialize qw/vpx_sub_pixel_avg_variance8x4 neon msa mmi/, "$sse2_asm", "$ssse3_asm";
...
add_proto qw/uint32_t vpx_sub_pixel_avg_variance4x8/, "const uint8_t *src_ptr, int src_stride, int x_offset, int y_offset, const uint8_t *ref_ptr, int ref_stride, uint32_t *sse, const uint8_t *second_pred";
  specialize qw/vpx_sub_pixel_avg_variance4x8 neon msa mmi/, "$sse2_asm", "$ssse3_asm";
...
add_proto qw/uint32_t vpx_sub_pixel_avg_variance4x4/, "const uint8_t *src_ptr, int src_stride, int x_offset, int y_offset, const uint8_t *ref_ptr, int ref_stride, uint32_t *sse, const uint8_t *second_pred";
  specialize qw/vpx_sub_pixel_avg_variance4x4 neon msa mmi/, "$sse2_asm", "$ssse3_asm";
...
if (vpx_config("CONFIG_VP9_HIGHBITDEPTH") eq "yes") {
  ...
  specialize qw/vpx_highbd_12_variance64x64 neon sve/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_12_variance64x32 neon sve/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_12_variance32x64 neon sve/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_12_variance32x32 neon sve/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_12_variance32x16 neon sve/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_12_variance16x32 neon sve/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_12_variance16x16 neon sve/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_12_variance16x8 neon sve/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_12_variance8x16 neon sve/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_12_variance8x8 neon sve/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_10_variance64x64 neon sve/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_10_variance64x32 neon sve/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_10_variance32x64 neon sve/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_10_variance32x32 neon sve/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_10_variance32x16 neon sve/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_10_variance16x32 neon sve/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_10_variance16x16 neon sve/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_10_variance16x8 neon sve/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_10_variance8x16 neon sve/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_10_variance8x8 neon sve/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_8_variance64x64 neon sve/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_8_variance64x32 neon sve/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_8_variance32x64 neon sve/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_8_variance32x32 neon sve/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_8_variance32x16 neon sve/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_8_variance16x32 neon sve/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_8_variance16x16 neon sve/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_8_variance16x8 neon sve/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_8_variance8x16 neon sve/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_8_variance8x8 neon sve/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_8_get8x8var neon sve/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_10_get8x8var neon sve/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_12_get8x8var neon sve/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_8_mse16x16 neon neon_dotprod/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_8_mse8x8 neon neon_dotprod/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_10_mse16x16 neon sve/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_10_mse8x8 neon sve/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_12_mse16x16 neon sve/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_12_mse8x8 neon sve/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_12_sub_pixel_variance64x64 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_12_sub_pixel_variance64x32 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_12_sub_pixel_variance32x64 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_12_sub_pixel_variance32x32 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_12_sub_pixel_variance32x16 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_12_sub_pixel_variance16x32 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_12_sub_pixel_variance16x16 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_12_sub_pixel_variance16x8 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_12_sub_pixel_variance8x16 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_12_sub_pixel_variance8x8 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_12_sub_pixel_variance8x4 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_10_sub_pixel_variance64x64 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_10_sub_pixel_variance64x32 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_10_sub_pixel_variance32x64 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_10_sub_pixel_variance32x32 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_10_sub_pixel_variance32x16 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_10_sub_pixel_variance16x32 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_10_sub_pixel_variance16x16 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_10_sub_pixel_variance16x8 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_10_sub_pixel_variance8x16 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_10_sub_pixel_variance8x8 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_10_sub_pixel_variance8x4 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_8_sub_pixel_variance64x64 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_8_sub_pixel_variance64x32 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_8_sub_pixel_variance32x64 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_8_sub_pixel_variance32x32 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_8_sub_pixel_variance32x16 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_8_sub_pixel_variance16x32 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_8_sub_pixel_variance16x16 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_8_sub_pixel_variance16x8 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_8_sub_pixel_variance8x16 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_8_sub_pixel_variance8x8 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_8_sub_pixel_variance8x4 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_12_sub_pixel_avg_variance64x64 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_12_sub_pixel_avg_variance64x32 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_12_sub_pixel_avg_variance32x64 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_12_sub_pixel_avg_variance32x32 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_12_sub_pixel_avg_variance32x16 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_12_sub_pixel_avg_variance16x32 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_12_sub_pixel_avg_variance16x16 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_12_sub_pixel_avg_variance16x8 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_12_sub_pixel_avg_variance8x16 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_12_sub_pixel_avg_variance8x8 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_12_sub_pixel_avg_variance8x4 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_10_sub_pixel_avg_variance64x64 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_10_sub_pixel_avg_variance64x32 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_10_sub_pixel_avg_variance32x64 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_10_sub_pixel_avg_variance32x32 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_10_sub_pixel_avg_variance32x16 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_10_sub_pixel_avg_variance16x32 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_10_sub_pixel_avg_variance16x16 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_10_sub_pixel_avg_variance16x8 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_10_sub_pixel_avg_variance8x16 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_10_sub_pixel_avg_variance8x8 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_10_sub_pixel_avg_variance8x4 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_8_sub_pixel_avg_variance64x64 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_8_sub_pixel_avg_variance64x32 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_8_sub_pixel_avg_variance32x64 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_8_sub_pixel_avg_variance32x32 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_8_sub_pixel_avg_variance32x16 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_8_sub_pixel_avg_variance16x32 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_8_sub_pixel_avg_variance16x16 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_8_sub_pixel_avg_variance16x8 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_8_sub_pixel_avg_variance8x16 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_8_sub_pixel_avg_variance8x8 neon/, "$sse2_asm";
  ...
  specialize qw/vpx_highbd_8_sub_pixel_avg_variance8x4 neon/, "$sse2_asm";
...
if (vpx_config("CONFIG_POSTPROC") eq "yes" || vpx_config("CONFIG_VP9_POSTPROC") eq "yes") {
    ...
    specialize qw/vpx_plane_add_noise msa/, "$sse2_asm";
    ...
    specialize qw/vpx_mbpost_proc_across_ip neon msa vsx/, "$sse2_asm";
    ...
    specialize qw/vpx_post_proc_down_and_across_mb_row neon msa vsx/, "$sse2_asm";
