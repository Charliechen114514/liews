# CTF SHA2: Confidential Space Challenge

This directory contains the Confidential Space variant of the SHA2 falsification
challenge.
...
```bash
./ctf_sha2/confidential_space/deploy_workload.sh
```
