...
// Forked from the Nucleus codebase and adapted so it compiles within Oak.
// https://github.com/google/nucleus/blob/main/nucleus/testing/protocol-buffer-matchers.h
// See https://github.com/protocolbuffers/protobuf/issues/3142 for more details.
...
// ========
//
//   using ::oak::testing::EqualsProto;
//   using ::oak::testing::EquivToProto;
//   using ::oak::testing::proto::Approximately;
//   using ::oak::testing::proto::Partially;
//   using ::oak::testing::proto::WhenDeserialized;
//
...
#ifndef THIRD_PARTY_OAK_TESTING_PROTOCOL_BUFFER_MATCHERS_H_
#define THIRD_PARTY_OAK_TESTING_PROTOCOL_BUFFER_MATCHERS_H_
...
namespace oak::testing::proto_matchers {
...
#endif  // THIRD_PARTY_OAK_TESTING_PROTOCOL_BUFFER_MATCHERS_H_