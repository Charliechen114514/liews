...
#ifndef CC_CRYPTO_TINK_SIGNATURE_TESTING_SIGNATURE_UTILS_H_
#define CC_CRYPTO_TINK_SIGNATURE_TESTING_SIGNATURE_UTILS_H_
...
// The private key is dropped, under the assumption the caller does not need it
// (because SignWithTink is only expected to be used for testing purposes).
absl::StatusOr<SignatureWrapper> SignWithTink(absl::string_view message);

}  // namespace oak::crypto::tink

#endif  // CC_CRYPTO_TINK_SIGNATURE_TESTING_SIGNATURE_UTILS_H_
