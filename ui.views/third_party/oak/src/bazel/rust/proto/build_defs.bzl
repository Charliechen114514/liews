...
"""Bazel build definitions for protobufs in Rust."""
...
_generate_service_lib = rule(
    ...
    attrs = {
        ...
        "_generator": attr.label(
            default = Label("//bazel/rust/proto:generator"),
            executable = True,
            cfg = "exec",
        ),
        "_protoc": attr.label(
...
def rust_proto_library(
        ...
        extern_paths = {},
        **kwargs):
    """A macro that generates a Rust protobuf library.

    Args:
        name: The name of the Rust protobuf library.
        srcs: Proto files to generate Rust protobuf code from.
        deps: Dependencies on external Rust libraries required by the generated library.
        extern_paths: A mapping of (fully-qualified) proto package names to external crate paths.
            ...
            NOTE: for now, the transitive closure of external crate paths must be included here.
