...
/// A builder for constructing a `Standalone` instance.
///
/// This builder is useful for generating mock endorsed evidence and key pairs
/// during unit and integration testing without requiring a real TEE
/// environment.
