//===---------- Oak implementation of IO utils ------------------*- C++ -*-===//
//
...
#ifndef LLVM_LIBC_SRC___SUPPORT_OSUTIL_OAK_IO_H
#define LLVM_LIBC_SRC___SUPPORT_OSUTIL_OAK_IO_H
...
// These are intended to be provided by the vendor (the Oak Restricted Kernel
// enclave application's Rust runtime).
//
...
#endif // LLVM_LIBC_SRC___SUPPORT_OSUTIL_OAK_IO_H
