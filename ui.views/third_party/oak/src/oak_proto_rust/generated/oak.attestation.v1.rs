...
pub struct BinaryArgvRegexMeasurement {
    ...
    /// measurement.
    #[prost(string, tag = "1")]
    pub binary_static_argv_regex: ::prost::alloc::string::String,
    /// Whether the `binary_static_argv_regex` matched the command line arguements
    /// at build time.
    #[prost(bool, tag = "2")]
...
pub struct Stage0TransparentMeasurements {
    ...
    /// TODO: b/452735395 - Change this field to BinaryCommandLine.
